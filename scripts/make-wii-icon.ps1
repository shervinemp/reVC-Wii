...
$halo.AddEllipse([float]($glowSpot.X - 40*$S), [float]($glowSpot.Y - 17*$S), [float](80*$S), [float](34*$S))
...
$gfx.FillEllipse($haloBrush, [float]($glowSpot.X - 40*$S), [float]($glowSpot.Y - 17*$S), [float](80*$S), [float](34*$S))
